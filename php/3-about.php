    ...
    <div class="container">
        <div class="grid">
            <div class="grid__item">
              <img src="./img/PP.png" width="410" height="303" loading="lazy" alt="John Doe - Développeur web freelance">
            </div>
            <div class="grid__item">
              <h2 class="section-title">A propos</h2>
              <h3>Qui suis-je ?</h3>
              <p>Lucarz Leo, né le 08/01/2003.</p>
              <p>Titulaire du Bac STI2D, j’ai suivi une 1ère année à l'IUT en alternance. A l’issu de cette année, j'ai souhaité me tourner vers une formation qui était plus en adéquation avec mes objectifs. Je me suis inscrit dans un BTS dont l’orientation principale est « Infrastructures serveurs et réseau ».</p>
